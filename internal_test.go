...
/*
This test file is part of the vdsutil package rather than than the
vdsutil_test package so it can bridge access to the internals to properly test
...
import (
	"github.com/Roasbeef/vdsutil/bech32"
