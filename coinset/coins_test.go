...
import (
	...
	"github.com/merkleroot/vdsutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    vdsutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() vdsutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value vdsutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = vdsutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = vdsutil.NewTxFromBytes(testSimpleCoinTxBytes)
